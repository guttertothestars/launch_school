...
def alphabetic_number_sort(num_array)
  ...
  num_array.sort.map! {|num| NUMBERS.key(num)} #HASH.key(value) returns a hash key based on the 1st corresponding value
end


#LaunchSchool Solution, which does NOT mutate the caller:
